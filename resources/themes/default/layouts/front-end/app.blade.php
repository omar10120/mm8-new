    ...
    <div id="app-banner" class="app-download-popup" style="--bottom: 30px;">
        <div class="d-flex gap-3 align-items-center">
            ...
            <div class="flex-grow-1">
                <h5 class="fs-14 mb-1">mm8 {{ translate('Mobile_App') }}</h5>
...
<script>
    ...
    $(document).on('click','#cookie-accept',function() {
        document.cookie = 'mm8_cookie_consent=accepted; max-age=' + 60 * 60 * 24 * 30;
        $('#cookie-section').hide();
    });
    $(document).on('click','#cookie-reject',function() {
        document.cookie = 'mm8_cookie_consent=reject; max-age=' + 60 * 60 * 24;
        $('#cookie-section').hide();
    });

    $(document).ready(function() {
        if (document.cookie.indexOf("mm8_cookie_consent=accepted") !== -1) {
            $('#cookie-section').hide();
        } else if (document.cookie.indexOf("mm8_cookie_consent=reject") !== -1) {
            $('#cookie-section').hide();
        } else{
