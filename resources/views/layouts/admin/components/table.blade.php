                        ...
                        <nav>
                            <ul class="pagination">
                                ...
                                <li class="page-item"><a class="page-link"
                                        href="http://localhost/Backend-mm8-eCommerce-CMS/admin/report/inhouse-product-sale?added_by=in_house&amp;page=2">2</a>
                                </li>
                                <li class="page-item"><a class="page-link"
                                        href="http://localhost/Backend-mm8-eCommerce-CMS/admin/report/inhouse-product-sale?added_by=in_house&amp;page=3">3</a>
                                </li>
                                <li class="page-item"><a class="page-link"
                                        href="http://localhost/Backend-mm8-eCommerce-CMS/admin/report/inhouse-product-sale?added_by=in_house&amp;page=4">4</a>
                                </li>
                                <li class="page-item"><a class="page-link"
                                        href="http://localhost/Backend-mm8-eCommerce-CMS/admin/report/inhouse-product-sale?added_by=in_house&amp;page=5">5</a>
                                </li>
                                <li class="page-item"><a class="page-link"
                                        href="http://localhost/Backend-mm8-eCommerce-CMS/admin/report/inhouse-product-sale?added_by=in_house&amp;page=6">6</a>
                                </li>
                                <li class="page-item"><a class="page-link"
                                        href="http://localhost/Backend-mm8-eCommerce-CMS/admin/report/inhouse-product-sale?added_by=in_house&amp;page=7">7</a>
                                </li>
                                <li class="page-item"><a class="page-link"
                                        href="http://localhost/Backend-mm8-eCommerce-CMS/admin/report/inhouse-product-sale?added_by=in_house&amp;page=8">8</a>
                                </li>
                                <li class="page-item">
                                    <a class="page-link"
                                        href="http://localhost/Backend-mm8-eCommerce-CMS/admin/report/inhouse-product-sale?added_by=in_house&amp;page=2"
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-center">
                                            <div class="avatar-60 d-flex align-items-center rounded">
                                                <img class="img-fluid" alt=""
                                                    src="http://localhost/Backend-mm8-eCommerce-CMS/storage/app/public/category/2025-03-17-67d7b1ec80932.webp">
                                            </div>
                                        </td>
                                        <td>demoo</td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form action="http://localhost/Backend-mm8-eCommerce-CMS/admin/category/status"
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-3">
                                                <a class="btn btn-outline-info icon-btn edit" title="Edit"
                                                    href="http://localhost/Backend-mm8-eCommerce-CMS/admin/category/update/294">
                                                    <i class="fi fi-sr-pencil"></i>
                                                </a>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <form action="http://localhost/Backend-mm8-eCommerce-CMS/admin/category/status" method="post"
