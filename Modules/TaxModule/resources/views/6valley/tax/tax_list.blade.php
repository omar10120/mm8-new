...
@section('content')
    ...
    @include("taxmodule::mm8.tax.partials.vat-tax-create")

    @foreach ($vatTaxes as $key => $vatTax)
        @include("taxmodule::mm8.tax.partials.vat-tax-update", ['vatTax' => $vatTax])
    @endforeach

    @include("taxmodule::mm8.offcanvas._vat-tax-create")
@endsection
