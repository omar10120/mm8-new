...
@section('content')
    <div class="text-center text-white mb-4">
        <h2>{{ "mm8market Software Installation" }}</h2>
        <h6 class="fw-normal">
    ...
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="mm8market Software Installation"
        ...
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            ...
            <div class="text-center">
                ...
                @if ($permission['curl_enabled'] == 1 && $permission['db_file_write_perm'] == 1 && $permission['routes_file_write_perm'] == 1 && $phpVersion >= 8.2)
                    <a href="{{ route('step3') }}?token={{ bcrypt('step_3') }}" class="btn btn-dark px-sm-5">
                        {{ "Proceed Next" }}
                    </a>
                @endif
            </div>
