...
trait VatTaxConfiguration
{
    ...
    public static function getProjectWiseViewPath($name)
    {
        $allProjects = [
            ...
            'mm8' => [
                'tax_list' => 'taxmodule::mm8.tax.tax_list',
                'tax_list_export' => 'taxmodule::mm8.file-exports.tax_list_export',
                'admin_tax_report' => 'taxmodule::mm8.file-exports.admin_tax_report',
                'system_tax_setup' => 'taxmodule::mm8.tax.system_tax_setup',
            ],
        ];
